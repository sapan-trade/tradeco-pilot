  ...
  return (
    <div className="invoice">
      ...
      <div className="invoice-foot">
        ...
        Generated by Clearwise on {new Date().toLocaleString()}.
        {pkg.snapshotAt && ` Cost snapshot taken ${new Date(pkg.snapshotAt).toLocaleDateString()}.`}
        <br />
        <span style={{ fontStyle: "italic" }}>
          This is a generated draft, not a filed customs entry. The declarant is responsible for the
          accuracy of all submitted data. HS codes are advisory and not legal or customs advice.
        </span>
      </div>
    </div>
  );
